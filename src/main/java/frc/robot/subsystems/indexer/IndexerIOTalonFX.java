...
/**
 * Real hardware implementation for the belt indexer using a TalonFX.
 * Configures current limits and direction on construction,
 * then just sets duty cycle percent when asked.
 */
