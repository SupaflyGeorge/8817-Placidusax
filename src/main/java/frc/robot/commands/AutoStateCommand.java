...
public class AutoStateCommand extends Command {
  ...
  public void execute() {
    ...
    if (action == AutoAction.SHOOT) {
      ...
      SmartDashboard.putBoolean("AutoMarker/ShootReady", false);
    }
  }
  ...
  public void end(boolean interrupted) {
    ...
    SmartDashboard.putString("AutoMarker/CommandEnded", action.name());
    SmartDashboard.putBoolean("AutoMarker/CommandInterrupted", interrupted);
    SmartDashboard.putNumber("AutoMarker/CommandEndTime", Timer.getFPGATimestamp());
  }
